...
describe('тестирование редьюсера constructorSlice', () => {
  describe('тестирование экшена addIngredient', () => {
    ...
    test('тест добавления ингредиента в массив ingredients', () => {
    ...
    test('тест добавления булки в пустое поле', () => {
      const newState = constructorSlice(
        initialState,
        addIngredient({
          _id: '643d69a5c3f7b9001cfa093c',
    ...
    test('тест добавления булки с заменой ранее добавленной', () => {
  ...
  describe('тестирование экшена removeIngredient', () => {
    ...
    test('тетс удаления ингредиента из конструктора', () => {
      const newState = constructorSlice(
        initialState,
  ...
  describe('тестирование экшенов перемещения: moveIngredientUp & moveIngredientDown', () => {
    ...
    test('тест перемещения ингредиента на позицию выше', () => {
  ...
  describe('тест асинхронного POST экшена orderBurger', () => {
    const actions = {
      pending: {
